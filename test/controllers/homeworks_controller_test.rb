...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { assignment: @homework.assignment, finished?: @homework.finished?, help: @homework.help, link_to_homework: @homework.link_to_homework }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { assignment: @homework.assignment, finished?: @homework.finished?, help: @homework.help, link_to_homework: @homework.link_to_homework }
    assert_redirected_to homework_path(assigns(:homework))
  end
